              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        <input type="file" name="vendor_icon" value="fileupload" id="fileupload">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        <input type="file" name="vendor_banner" value="fileupload" id="fileupload">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text"   name="vendor_phone" id="vendor_phone" value="" class="form-control">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="vendor_password" id="vendor_password" value="" class="form-control" >
                    </div>
                  </div>        
...
<script src="https://maps.googleapis.com/maps/api/js?key={{env('APP_MAP_KEY')}}&libraries=places&callback=initMap" async defer></script>
@endsection
